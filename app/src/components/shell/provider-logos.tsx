 ...
 *
 * Each component renders into a 24x24 viewBox at 20x20 actual size; the
 * caller controls the surrounding circle / background. `currentColor` lets
 * the parent button style the fill.
 */
