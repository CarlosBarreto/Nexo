import { resolveAgentColor } from "@nexo-ai/core";
import {
  BarChart3,
  BookOpen,
  Bot,
...
import nexoIcon from "../../assets/nexo-icon.svg";
import nexoIconWhite from "../../assets/nexo-icon-white.svg";
